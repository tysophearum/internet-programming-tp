  ...
  <div class="flex flex-col w-full h-[100vh] justify-center items-center md:flex-row">
    ...
    <div>
      <form onsubmit="return false" class="border p-4">
        ...
        <input v-model="username" type="text" name="username" placeholder="Enter username" class="border-gray-200 h-10 border-2 w-full px-4 mb-3">
...
export default {
  ...
  methods: {
    login: function () {
      // console.log($refs.username.value);s
