    ...
    <div class="relative w-full max-w-md max-h-full">
        <form class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <button data-modal-hide="popup-modal" @click="deleteProduct" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
...
export default {
    ...
    methods: {
        cancel() {
            this.$store.commit("showDeleteProduct", false)
            console.log(this.$store.state.deleteProductId);
        },
        deleteProduct() {
            axios.post("http://localhost:3000/product/delete", {_id: this.$store.state.deleteProductId})
            .then(res => {
                console.log(res);
            })
        }
